...
const manifest: Manifest = {
  ...
  name: "test",
  components: {
    auth: { path: "./src/auth", docs: { interface: "./docs/auth/interface.md", internal: "./docs/auth/internal.md" } },
    api: { path: "./src/api", depends_on: ["auth"], docs: { interface: "./docs/api/interface.md", internal: "./docs/api/internal.md" } },
  },
};
