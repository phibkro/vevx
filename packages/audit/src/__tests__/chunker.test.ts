...
describe('File Chunking', () => {
  ...
  it('creates single chunk when files fit under limit', () => {
    const files = [
      createMockFile(100, 'small1.ts'),
      createMockFile(100, 'small2.ts')
    ]
  ...
  it('creates multiple chunks when files exceed limit', () => {
    const files = [
      createMockFile(5000, 'large1.ts'),
      createMockFile(5000, 'large2.ts')
    ]
