...
describe('parseAuditResponse', () => {
  ...
  it('normalizes severity variations', () => {
    const raw = JSON.stringify({
      findings: [
        { ruleId: 'A', severity: 'warning', title: 't', description: '', locations: [{ file: 'a.ts', startLine: 1 }], evidence: '', remediation: '', confidence: 0.5 },
        { ruleId: 'B', severity: 'info', title: 't', description: '', locations: [{ file: 'b.ts', startLine: 1 }], evidence: '', remediation: '', confidence: 0.5 },
        { ruleId: 'C', severity: 'CRITICAL', title: 't', description: '', locations: [{ file: 'c.ts', startLine: 1 }], evidence: '', remediation: '', confidence: 0.5 },
      ],
    });
  ...
  it('clamps confidence to [0, 1]', () => {
    const raw = JSON.stringify({
      findings: [
        { ruleId: 'A', severity: 'high', title: 't', description: '', locations: [{ file: 'a.ts', startLine: 1 }], evidence: '', remediation: '', confidence: 1.5 },
        { ruleId: 'B', severity: 'high', title: 't', description: '', locations: [{ file: 'b.ts', startLine: 1 }], evidence: '', remediation: '', confidence: -0.3 },
      ],
    });
  ...
  it('handles missing location gracefully', () => {
    const raw = JSON.stringify({
      findings: [
        { ruleId: 'BAC-01', severity: 'high', title: 't', description: '', evidence: '', remediation: '', confidence: 0.8 },
      ],
    });
  ...
  it('handles single location object (not array)', () => {
    const raw = JSON.stringify({
      findings: [
        { ruleId: 'BAC-01', severity: 'high', title: 't', description: '', location: { file: 'x.ts', startLine: 5 }, evidence: '', remediation: '', confidence: 0.8 },
      ],
    });
  ...
  it('accepts snake_case field names from LLM', () => {
    const raw = JSON.stringify({
      findings: [
        { rule_id: 'BAC-01', severity: 'high', title: 't', description: '', locations: [{ file: 'a.ts', start_line: 10, end_line: 15 }], evidence: '', remediation: '', confidence: 0.8 },
      ],
    });
  ...
  it('truncates long titles to 80 chars', () => {
    ...
    const raw = JSON.stringify({
      findings: [
        { ruleId: 'BAC-01', severity: 'high', title: longTitle, description: '', locations: [{ file: 'a.ts', startLine: 1 }], evidence: '', remediation: '', confidence: 0.8 },
      ],
    });
