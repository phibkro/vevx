...
export const accessibilityAgent = createAgent({
  name: "accessibility",
  weight: 0.1,
  systemPrompt: SYSTEM_PROMPT,
  topic: "accessibility issues",
  fileFilter: (f) => /\.(jsx|tsx|vue|html|svelte)$/.test(f.relativePath),
  emptyMessage:
    "No UI code files found. Return score 10 with summary: 'No UI code to analyze for accessibility'",
});
