...
function createClient() {
    ...
    if (!apiKey) {
        throw new ValidationError("ANTHROPIC_API_KEY", "Environment variable is not set. Please set it with: export ANTHROPIC_API_KEY='your-api-key'");
    }
 ...
 */
export async function testConnection(model = "claude-sonnet-4-5-20250929") {
    console.log("Testing Anthropic API connection...");
    try {
        const response = await callClaude("You are a helpful assistant. Respond concisely.", "Say 'API connection successful' and nothing else.", { model, maxTokens: 100 });
        console.log("✓ Success!");
