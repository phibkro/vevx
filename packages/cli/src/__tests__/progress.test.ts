...
describe("Progress Reporter", () => {
  ...
  it("shows completion for each agent with score and duration", () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining("correctness"));
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining("8.5"));
  ...
  it("shows total duration when all agents complete", () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining("5.2"));
